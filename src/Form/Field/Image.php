 ...
 * @method $this drawCircle(int $x, int $y, \Closure|Circle $init) Draw a colored circle on the current image with its center position at the x, y coordinates. Define the overall appearance of the shape by passing a init callback as an optional parameter.
